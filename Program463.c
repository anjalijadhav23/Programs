...
int main()
{
    ...
    iRet1 = CountLeafNode(Head);
    printf("Number of leaf node is : %d\n",iRet1);

    iRet2 = CountParentNode(Head);
    printf("Number of PArent nodes is : %d\n",iRet2);

    iRet3 = CountCompleteParentNode(Head);
    printf("Number of Complete Parent nodes is : %d\n",iRet3);

    iRet4 = CountEvenNode(Head);
    printf("Number of even nodes is : %d\n",iRet4);
